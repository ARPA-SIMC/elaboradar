...
void to::test<1>()
{
    ...
    wassert(actual(stats.count_ones[0]) == 197515);
    wassert(actual(stats.count_ones[1]) == 197532);
    ...
    wassert(actual(stats.count_others[0]) ==  85);
    wassert(actual(stats.count_others[1]) ==  68);
    ...
    wassert(actual(stats.sum_others[0]) ==   5948);
    wassert(actual(stats.sum_others[1]) ==   4755);
    ...
    wassert(actual(*cb->qual).statsEqual(1, 52.19, 99));
    ...
    wassert(actual(cb->quota).statsEqual(1, 1543.5, 5813));
...
void to::test<3>()
{
    ...
    cb->caratterizzo_volume();
    // print_stats("cb", *cb, cerr);
    wassert(actual(*cb->qual).statsEqual(1, 53.06, 99));
    wassert(actual(cb->top).statsEqual(0, 196947, 1, 3.32, 15));
    wassert(actual(cb->first_level).statsEqual(0, 0.54, 3));
    wassert(actual(cb->first_level_static).statsEqual(0, 0.54, 3));
    wassert(actual(cb->bb_first_level).statsEqual(0, 0.49, 2));
    wassert(actual(cb->beam_blocking).statsEqual(0, 10.43, 51));
    wassert(actual(cb->dem).statsEqual(-9999, 47.59, 4070.26));
...
//     print_stats("cart", cart, cout);
    ...
    wassert(actual(cart.qual_Z_cart).statsEqual(0, 213127, 1, 36.61, 98));
    ...
    wassert(actual(cart.beam_blocking_xy).statsEqual(0, 691399, 1, 47.08, 51));
...
//     print_stats("clow", clow, cerr);
    ...
    wassert(actual(clow.qual_Z_1x1).statsEqual(0, 17489, 1, 36.24, 98));
    ...
    wassert(actual(clow.beam_blocking_1x1).statsEqual(0, 47349, 1, 47.16, 51));
...
void to::test<6>()
{
    ...
    wassert(actual(cb->beam_blocking).statsEqual(0, 10.28, 51));
...
//    print_stats("cart", cart, cerr);
    ...
    wassert(actual(cart.beam_blocking_xy).statsEqual(0, 730908, 1, 46.61, 51));
...
//     print_stats("clow", clow, cerr);
    ...
    wassert(actual(clow.beam_blocking_1x1).statsEqual(0, 44623, 1, 46.29, 51));
...
void to::test<10>()
{
    ...
    wassert(actual(cb->beam_blocking).statsEqual(0, 15.49, 51));
...
//     print_stats("cb", *cb, cerr);
    wassert(actual(*cb->qual).statsEqual(1, 54.51, 99));
...
//     print_stats("cart", cart, cerr);
    ...
    wassert(actual(cart.qual_Z_cart).statsEqual(0, 624947, 1, 19.45, 98));
    ...
    wassert(actual(cart.beam_blocking_xy).statsEqual(0, 1791326, 1, 49.94, 51));
...
//     print_stats("clow", clow, cerr);
    ...
    wassert(actual(clow.qual_Z_1x1).statsEqual(0, 0, 1, 32.18, 97));
    ...
    wassert(actual(clow.beam_blocking_1x1).statsEqual(0, 43446, 1, 50.23, 51));
