...
const int elev_array_spc[NEL]={6,15,26,36,46,57,80,108,148,159,170,180,190,200,210};//GLI ULTIMI 5 fittizi: ANNA 30-03-2011
const int elev_array_gat[NEL]={6,16,27,37,45,55,65,76,85,95,105,126,149,174,201};//105,126,149,174,201 è da completare NEL=15:ANNA 30-03-2011
#endif
// v. parametri SHORT
#ifdef MEDIUM
#define NEL 5
...
const int elev_array_spc[NEL]={6,16,26,36,47};//ANNA 30-03-2011
const int elev_array_gat[NEL]={6,16,27,36,47};//ANNA 30-03-2011
#define NMIN 2
...
#warning This code used to work like this, by accident, in C: this is a workaround to maintain functional equivalence during porting to c++
    ...
    void calcolo_background() // sui punti precipitanti calcolo bckgr . nb LA CLASSIFICAZIONE DI STEINER NON HA BISOGNO DI RICAMPIONAMENTO CILINDRICO PERCIÒ uso direttamente la matrice polare
    ...
    bool esegui_tutto(const char* nome_file, const char* tipofile, const char* sito)
    {
        ...
        //--------lettura volume------
        ier = read_dbp_SP20((char*)nome_file,vol_pol,&old_data_header,
