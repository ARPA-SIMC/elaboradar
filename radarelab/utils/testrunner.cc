...
using namespace std;
using namespace radarelab::utils;
...
SimpleTestController::SimpleTestController(radarelab::utils::term::Terminal& output)
    : output(output)
{
}
...
VerboseTestController::VerboseTestController(radarelab::utils::term::Terminal& output)
    : output(output) {}
...
struct Title
{
    radarelab::utils::term::Terminal& output;
    std::string title;
    bool printed = false;

    Title(radarelab::utils::term::Terminal& output, const std::string& title)
...
void TestResultStats::print_results(radarelab::utils::term::Terminal& out)
{
...
void TestResultStats::print_stats(radarelab::utils::term::Terminal& out)
{
...
void TestResultStats::print_summary(radarelab::utils::term::Terminal& out)
{
