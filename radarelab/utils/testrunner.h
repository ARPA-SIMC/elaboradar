#ifndef RADARELAB_UTILS_TESTSRUNNER_H
#define RADARELAB_UTILS_TESTSRUNNER_H
...
struct SimpleTestController : public FilteringTestController
{
    ...
    SimpleTestController(radarelab::utils::term::Terminal& output);
...
struct VerboseTestController : public FilteringTestController
{
    ...
    VerboseTestController(radarelab::utils::term::Terminal& output);
...
struct TestResultStats
{
    ...
    void print_results(radarelab::utils::term::Terminal& out);
    void print_stats(radarelab::utils::term::Terminal& out);
    void print_summary(radarelab::utils::term::Terminal& out);
};
