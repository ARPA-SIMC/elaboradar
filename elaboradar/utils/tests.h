#ifndef ELABORADAR_UTILS_TESTS_H
#define ELABORADAR_UTILS_TESTS_H
 ...
 */
extern const elaboradar::utils::tests::LocationInfo elaboradar_utils_test_location_info;
 ...
 * test_function(...)
 * {
 *    ELABORADAR_UTILS_TEST_INFO(info);
 ...
 */
#define ELABORADAR_UTILS_TEST_INFO(name) \
    elaboradar::utils::tests::LocationInfo elaboradar_utils_test_location_info; \
    elaboradar::utils::tests::LocationInfo& name = elaboradar_utils_test_location_info
...
#define wassert(...) \
    do { try { \
        __VA_ARGS__ ; \
    } catch (elaboradar::utils::tests::TestFailed& e) { \
        e.add_stack_info(__FILE__, __LINE__, #__VA_ARGS__, elaboradar_utils_test_location_info); \
        throw; \
    } catch (std::exception& e) { \
        throw elaboradar::utils::tests::TestFailed(e, __FILE__, __LINE__, #__VA_ARGS__, elaboradar_utils_test_location_info); \
    } } while(0)
...
#define wcallchecked(func) \
    [&]() { try { \
        ...
        e.add_stack_info(__FILE__, __LINE__, #func, elaboradar_utils_test_location_info); \
        throw; \
    } catch (std::exception& e) { \
        throw elaboradar::utils::tests::TestFailed(e, __FILE__, __LINE__, #func, elaboradar_utils_test_location_info); \
    } }()
